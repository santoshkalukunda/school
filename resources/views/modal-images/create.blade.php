@extends('layouts.app', ['title' => __('Modal Images Create')])
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ $modalImage->id ? route('modal-images.update', $modalImage) : route('modal-images.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @if ($modalImage->id)
                                @method('put')
                            @endif
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title"
                                            ...
                                            value="{{ old('title', $modalImage->title) }}" id="title"
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="url" name="url"
                                            ...
                                            value="{{ old('url', $modalImage->url) }}" id="url"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="descriptions" class="form-control"  rows="5">{{$modalImage->descriptions}}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="status" id="status"
                                            ...
                                            <option value="1" {{ $modalImage->status == '1' ? 'selected' : '' }}>
                                                Publish</option>
                                            <option value="0" {{ $modalImage->status == '0' ? 'selected' : '' }}>
                                                Unpublish</option>
                                        </select>
                                ...
                                <div class="mb-3 text-end">
                                    <button type="submit" class="btn btn-primary">
                                        {{ $modalImage->id ? 'Update' : 'Save' }}</button>
                                </div>
                        </form>
